...
const DeleteNoteForm = ({student, setOpen, loadData}) => {
  ...
  return (
    <Box>
      <h1 className={classes.titleModal}><p className={classes.positionTitle}>Delete student</p></h1>
      <p className={classes.deleteMessage}>Delete "{student.studentName} {student.studentSurname}"?</p>
